...
class PercipioAxiosContentDiscoveryServiceClient extends PercipioAxiosClient {
   ...
   * @property {"CSOD"|"Degreed"|"Moodle"|"Saba"|"SuccessFactors"|"SumTotalLearn"|"Generic"|"Wo
   * rkday2"} [config.params.system] - system name value to be used to look for respecitve ORG
   * SYNC
  ...
  getCatalogContentV2({ params = {}, ...other }) {
    ...
    const paramsToUse = (({
      ...
      system,
      pagingRequestId,
    }) => ({ transformName, updatedSince, offset, max, system, pagingRequestId }))(params);

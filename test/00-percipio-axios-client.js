...
describe('PercipioAxiosClient', function () {
  describe('constructors', function () {
    ...
    it('throws PropertyRequiredError if baseURL is not supplied', function () {
      ...
      expect(() => new PercipioAxiosClient(config)).to.throw(PropertyRequiredError);
    });
    ...
    it('throws PropertyInvalidError if baseURL is not url', function () {
      ...
      expect(() => new PercipioAxiosClient(config)).to.throw(PropertyInvalidError);
    });
    ...
    it('creates PercipioAxiosClient', function () {
      const client = new PercipioAxiosClient(mainconfig);
      expect(client).to.be.instanceof(PercipioAxiosClient);

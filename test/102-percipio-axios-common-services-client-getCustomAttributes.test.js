...
describe(' PercipioAxiosCommonServicesClient', function () {
  describe('getCustomAttributes function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    beforeEach(function () {
      ...
      requestNock = testutils.getOperationNock(
        mainconfig.baseURL,
        '/common/v1/organizations/{orgId}/custom-attributes',
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.getCustomAttributes(requestConfig).then((response) => {

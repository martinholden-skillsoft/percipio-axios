...
describe(' PercipioAxiosUserManagementServiceClient', function () {
  describe('updateUserByUuid function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    function setupConfigs() {
      ...
      pathPlaceHoldersConfig.id = '052ee3e7-ec92-49c9-966c-69118cfb185b';
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.updateUserByUuid(requestConfig).then((response) => {

...
describe('PercipioAxiosClient', function () {
  convenienceMethods.forEach(function (functionName) {
    describe(`${functionName} convenience function`, function () {
      ...
      it('use custom axios instance without timingAdapter to confirm response does not contain timing data', async function () {
      ...
      it('confirm querystring params sent', async function () {
        const client = new PercipioAxiosClient(mainconfig);
      ...
      it('confirm body sent', async function () {
        const client = new PercipioAxiosClient(mainconfig);

...
describe(' PercipioAxiosUserManagementServiceClient', function () {
  describe('getBatchUsersRequest function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    function setupConfigs() {
      ...
      pathPlaceHoldersConfig.batchUsersRequestId = 'f56d7c96-1370-44f6-b9b6-1ae09dd4de1c';
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.getBatchUsersRequest(requestConfig).then((response) => {

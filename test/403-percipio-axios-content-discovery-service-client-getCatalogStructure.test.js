...
describe(' PercipioAxiosContentDiscoveryServiceClient', function () {
  describe('getCatalogStructure function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    beforeEach(function () {
      ...
      requestNock = testutils.getOperationNock(
        mainconfig.baseURL,
        '/content-discovery/v1/organizations/{orgId}/catalog-structure',
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.getCatalogStructure(requestConfig).then((response) => {

...
describe(' PercipioAxiosUserManagementServiceClient', function () {
  describe('upsertUserByLoginName function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    function setupConfigs() {
      ...
      pathPlaceHoldersConfig.loginName = '73d6d1e3-38c2-44a2-88f2-a17d7c43d9e1';
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.upsertUserByLoginName(requestConfig).then((response) => {

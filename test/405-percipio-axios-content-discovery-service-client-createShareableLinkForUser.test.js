...
describe(' PercipioAxiosContentDiscoveryServiceClient', function () {
  describe('createShareableLinkForUser function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    function setupConfigs() {
      ...
      pathPlaceHoldersConfig.userId = '89089018-79c3-4d7d-9a6a-4145535a2826';
      pathPlaceHoldersConfig.contentId = '38f0a6e0-b054-4b99-94bb-d730557209eb';
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.createShareableLinkForUser(requestConfig).then((response) => {

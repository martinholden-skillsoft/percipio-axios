...
describe(' PercipioAxiosUserManagementServiceClient', function () {
  describe('getUserByLoginName function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    function setupConfigs() {
      ...
      pathPlaceHoldersConfig.loginName = '45376bca-a466-4441-8568-76f3bf07b60a';
    ...
    beforeEach(function () {
      ...
      requestNock = testutils.getOperationNock(
        mainconfig.baseURL,
        '/user-management/v1/organizations/{orgId}/users/login-name/{loginName}',
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.getUserByLoginName(requestConfig).then((response) => {

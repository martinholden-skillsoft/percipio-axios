...
describe(' PercipioAxiosContentDiscoveryServiceClient', function () {
  describe('createShareableLinkForUrlWithOrg function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    beforeEach(function () {
      ...
      requestNock = testutils.getOperationNock(
        mainconfig.baseURL,
        '/content-discovery/v1/organizations/{orgId}/share-link/url',
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.createShareableLinkForUrlWithOrg(requestConfig).then((response) => {

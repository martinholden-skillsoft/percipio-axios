...
describe(' PercipioAxiosContentDiscoveryServiceClient', function () {
  describe('getComplianceContent function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    beforeEach(function () {
      ...
      requestNock = testutils.getOperationNock(
        mainconfig.baseURL,
        '/content-discovery/v1/organizations/{orgId}/compliance-content',
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.getComplianceContent(requestConfig).then((response) => {

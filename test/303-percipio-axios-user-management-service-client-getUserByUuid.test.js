...
describe(' PercipioAxiosUserManagementServiceClient', function () {
  describe('getUserByUuid function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    function setupConfigs() {
      ...
      pathPlaceHoldersConfig.id = 'b4660af3-2585-4b4c-8970-72402dd91e58';
    ...
    beforeEach(function () {
      ...
      requestNock = testutils.getOperationNock(
        mainconfig.baseURL,
        '/user-management/v1/organizations/{orgId}/users/{id}',
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.getUserByUuid(requestConfig).then((response) => {

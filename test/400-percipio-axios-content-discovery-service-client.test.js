...
describe('PercipioAxiosContentDiscoveryServiceClient', function () {
  describe('constructors', function () {
    ...
    it('throws PropertyRequiredError if baseURL is not supplied', function () {
      ...
      expect(() => new PercipioAxiosContentDiscoveryServiceClient(config)).to.throw(
        PropertyRequiredError
      );
    });
    ...
    it('creates PercipioAxiosContentDiscoveryServiceClient', function () {
      const client = new PercipioAxiosContentDiscoveryServiceClient(mainconfig);
      expect(client).to.be.instanceof(PercipioAxiosContentDiscoveryServiceClient);
      ...
      expect(client.getCatalogContentV2).to.be.instanceOf(
        Function,
        'getCatalogContentV2 is not a function of client'
      );
      expect(client.getSearchContent).to.be.instanceOf(
        Function,
        'getSearchContent is not a function of client'
      );
      expect(client.getCatalogStructure).to.be.instanceOf(
        Function,
        'getCatalogStructure is not a function of client'
      );
      expect(client.createShareableLinkForOrg).to.be.instanceOf(
        Function,
        'createShareableLinkForOrg is not a function of client'
      );
      expect(client.createShareableLinkForUser).to.be.instanceOf(
        Function,
        'createShareableLinkForUser is not a function of client'
      );
      expect(client.createShareableLinkForUrlWithOrg).to.be.instanceOf(
        Function,
        'createShareableLinkForUrlWithOrg is not a function of client'
      );
      expect(client.createShareableLinkForUrlWithUser).to.be.instanceOf(
        Function,
        'createShareableLinkForUrlWithUser is not a function of client'
      );
      expect(client.getComplianceContent).to.be.instanceOf(
        Function,
        'getComplianceContent is not a function of client'
      );
    });
  });
});

...
describe(' PercipioAxiosUserManagementServiceClient', function () {
  describe('createBatchUsersRequest function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    beforeEach(function () {
      ...
      requestNock = testutils.getOperationNock(
        mainconfig.baseURL,
        '/user-management/v1/organizations/{orgId}/batch-users-request',
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.createBatchUsersRequest(requestConfig).then((response) => {

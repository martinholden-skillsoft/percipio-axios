...
describe(' PercipioAxiosUserManagementServiceClient', function () {
  describe('upsertUserByExternalUserId function', function () {
    let mainconfig;
    let requestConfig;
    let requestNock;
    ...
    function setupConfigs() {
      ...
      pathPlaceHoldersConfig.externalUserId = '949fe0b3-c91d-4888-a1bb-47f7fd886097';
    ...
    it('confirm it has default headers', async function () {
      ...
      return client.upsertUserByExternalUserId(requestConfig).then((response) => {
